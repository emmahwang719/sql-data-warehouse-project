...
I work with **SQL, ETL, data warehousing, and data modeling**, with an emphasis on transforming raw data into clean, consistent, and analytics-ready datasets. Through my projects, I focus on practical data engineering problems such as **data quality, pipeline design, database architecture, and dimensional modeling**.
